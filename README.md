# Aux confins d'Athanor — Version HTML/CSS/JS

Portage fidèle du RPG textuel écrit en **Go** vers une page **HTML/CSS/JavaScript** autonome, jouable directement dans un navigateur, sans installation ni serveur.
...
### Formules de calcul (fidèles au code source)
